...
/***/ function(module, exports, __webpack_require__) {
	...
	var MainViewStore = __webpack_require__(161);
	var MainViewAction = __webpack_require__(167);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SearchView = __webpack_require__(159).view;
	...
	var MainViewController = React.createClass({displayName: "MainViewController",
	  ...
	  render: function () {
	    ...
	    return (
	        React.createElement("div", {className: "treeContainer"}, 
	          React.createElement(SearchView, {data: aSearchedData})
	        )
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NameContainerView = React.createClass({displayName: "NameContainerView",
	  getInitialState: function () {
	    var oData = {};
	  ...
	  getView: function () {
	    ...
	    for (var iIndex = 0; iIndex < aData.length; iIndex++) {
	      ...
	      aViews.push(
	          React.createElement("div", {className: "name-view"}, 
	            (oData).name, 
	            React.createElement("div", {className: "deleteName", onClick: this.handleNameDeleteOnClick.bind(this, oData)}, 
	              React.createElement("img", {src: "img/delete.png"})
	            ), 
	            React.createElement("div", {className: "moveUp", onClick: this.handleNameMoveUpOnClick.bind(this, oData)}, 
	              React.createElement("img", {src: "img/double-arrow-up.png"})
	            ), 
	            React.createElement("div", {className: "down", onClick: this.handleNameMoveDownOnClick.bind(this, oData)}, 
	              React.createElement("img", {src: "img/double-arrow-down.png"})
	            )
	  ...
	  render: function () {
	    return (
	        React.createElement("div", {className: "name-container"}, 
	          React.createElement("div", {className: "searchTextBox"}, 
	            React.createElement("img", {src: "img/search.png"}), 
	            React.createElement("input", {type: "text", className: "test", value: this.state.textValue, onChange: this.handleOnChange, 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MicroEvent = __webpack_require__(162);
	var MainViewProps = __webpack_require__(164);
	var AppData = __webpack_require__(165);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MockDataForView = __webpack_require__(166);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var eventBus = __webpack_require__(160);
	var MainViewStore = __webpack_require__(161);
	var SearchViewEvent = __webpack_require__(159).events;
